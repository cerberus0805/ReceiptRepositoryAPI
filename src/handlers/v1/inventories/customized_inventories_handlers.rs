...
use crate::{
    models::v1::{errors::api_error::ApiError, parameters::{pagination::Pagination, query_filters::QueryFilters}, responses::response_inventory::{ResponseCustomizedInventoriesPayload, ResponseCustomizedInventoryPayload}}, repository::DbRepository, services::v1::{converters::api_error_converter_service::ApiErrorConventerService, inventories::customized_inventories_service::CustomizedInventroyService}
};
...
impl CustomizedInventoriesHandlers {
    ...
    pub async fn get_customized_inventories(State(repository): State<DbRepository>, pagination: Option<Query<Pagination>>, query_filters: Option<Query<QueryFilters>>) -> impl IntoResponse {
        let service = CustomizedInventroyService::new(&repository);
